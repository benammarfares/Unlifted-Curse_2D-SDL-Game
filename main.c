...
int choix=1;
sous_menu_1[0]=IMG_Load("multi_clicked.png");
sous_menu_1[1]=IMG_Load("mono_clicked.png");
...
if (Menu==3) afficher_story( screen);
}
while (Menu==2);
