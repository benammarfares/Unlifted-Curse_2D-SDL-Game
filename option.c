...
Mix_PlayMusic(music,-1);
    ...
    background = IMG_Load("./Game ress/Option/Background.png");
    ...
    volume[0] = IMG_Load("./Game ress/Option/Bar-1.png");
    volume[1] = IMG_Load("./Game ress/Option/Bar-2.png");
    volume[2] = IMG_Load("./Game ress/Option/Bar-3.png");
    volume[3] = IMG_Load("./Game ress/Option/Bar-4.png");
    int vl = 0, v = 0;
    if (volum == 0)
        v = 0;
    if (volum == 33)
    ...
    SDL_Surface *full[3];
    full[0] = IMG_Load("./Game ress/Option/Mini-screen.png");
    full[1] = IMG_Load("./Game ress/Option/Full-screen.png");
    int fl = 0;
    //pos buton full
    SDL_Rect full_pos;
    full_pos.x = 100;
    ...
    SDL_Surface *back[3];
    back[0] = IMG_Load("./Game ress/Option/Return-normal.png");
    back[1] = IMG_Load("./Game ress/Option/Return-selected.png");
    ...
    police = TTF_OpenFont("./Game ress/Option/DEADLY KILLERS.ttf", 40);
    SDL_Color couleur = {255, 255, 255}, couleur1 = {245,245,245};
